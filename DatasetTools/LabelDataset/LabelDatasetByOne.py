...
def main():
    ...
    dataset_path = '/media/frenky/Fery/Frenky/Skola/StratosphereHTTPSDetector/Dataset/Dataset_2_malware/CTU-Malware-Capture-Botnet-305-1/'

    bro_path = dataset_path + '/bro/'
    conn_list = get_all_conn_logs(bro_path)
    for conn_file in conn_list:
        conn_contain = label_conn(bro_path + conn_file, normal_ips_list=[], malware_ips_list=['192.168.1.113'])
